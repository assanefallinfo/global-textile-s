      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="text-white/70 mb-6">
              Votre spécialiste du tissu brodé haut de gamme à Dakar. Qualité, élégance et service client sont nos priorités.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#accueil" className="text-white/70 hover:text-gold transition-colors">Accueil</a>
              </li>
              <li>
                <a href="#à-propos" className="text-white/70 hover:text-gold transition-colors">À propos</a>
              </li>
              <li>
                <a href="#produits" className="text-white/70 hover:text-gold transition-colors">Nos produits</a>
              </li>
              <li>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-white/70">
                  Parcelles Assainies U12 – À côté de la SENELEC
                </span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 mt-1 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="tel:+221779677888" className="text-white/70 hover:text-gold transition-colors">
                  +221 77 967 78 88
                </a>
              </li>
              <li className="flex items-start">
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center">
          <p className="text-white/60">
            &copy; {year} Global Textile. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
