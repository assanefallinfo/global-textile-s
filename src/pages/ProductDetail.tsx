...
// Ajout des descriptions longues pour tous les produits
const productsWithLongDescriptions = [
  // Produits existants
  {
    id: 1,
...
const ProductDetail = () => {
  ...
  // Trouver la description longue correspondante
  const productLongDesc = productsWithLongDescriptions.find(p => p.id === productId);
  const longDescription = productLongDesc?.longDescription || "";
